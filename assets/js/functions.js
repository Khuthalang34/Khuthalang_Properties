    ...
    $sliderRange.each(function() {
        $(this).slider({
            ...
            slide: function(event, ui) {
                $(this).closest('.filter').find($sliderAmount).val("R" + ui.values[0] + " - R" + ui.values[1]);
            }
        });
        $(this).closest('.filter').find($sliderAmount).val("R" + $sliderRange.slider("values", 0) + " - R" + $sliderRange.slider("values", 1));
    });
