...
<head>
    ...
    <!-- Document Title
    ============================================= -->
	<title>Newlands | Khuthalang Properties</title>
    <style>
	.hero-map #googleMap {
            ...
            <div class="container-fluid pr-0 pl-0">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
						...
						<h1 class="surbarb-heading">Newlands</h1>
						</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <div class="row">
                            ...
                            <div class="properties properties-grid">
                                <!-- .col-md-12 end -->
                                <!--fetch properties in West Coast -->
                                ...
                                try {
                                  $q = 0;
                                    $SuburbName = 'Newlands';
                                     ...
                                     //$stmt->execute(array(':PropertySuburb' => 'West Coast'));
...
<!-- Mirrored from demo.zytheme.com/lalan/properties-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 May 2019 14:41:48 GMT -->
</html>
