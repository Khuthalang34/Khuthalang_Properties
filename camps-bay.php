...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Camps Bay | Khuthalang Properties</title>
            ...
            <div class="container-fluid pr-0 pl-0">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
						...
						<h1 class="surbarb-heading">Camps Bay</h1>
						</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <div class="row">
                            ...
                            <div class="properties properties-grid">
                               ...
                               <!--fetch properties in cape flats -->

                                <?php
                                try {
                                  $q = 0;

                                     $SuburbName = 'Camps Bay';
                                     //$stmt = $db->query('SELECT * FROM properties WHERE Suburb = '.$SuburbName.' ORDER BY properties.ID DESC');
                                     //$stmt->execute(array(':PropertySuburb' => 'Cape Flats'));
